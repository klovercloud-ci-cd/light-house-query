...
// Get... Get Api
// @Summary Get api
// @Description Api for getting all persistent volume  by agent name, owner reference and process id
...
func (p persistentVolumeApi) Get(context echo.Context) error {
	...
	data, total := p.persistentVolumeService.Get(agent, ownerReference, processId, option)
