...
func AgentRouter(g *echo.Group) {
	...
	g.GET(":agent/certificates/:certificateId", agentApi.GetPodsByCertificate)
	g.GET(":agent/clusterRoles/:clusterRoleId", agentApi.GetPodsByClusterRole)
	g.GET(":agent/clusterRoleBindings/:clusterRoleBindingId", agentApi.GetPodsByClusterRoleBinding)
	g.GET(":agent/configMaps/:configMapId", agentApi.GetPodsByConfigMap)
	g.GET(":agent/daemonSets/:daemonSetId", agentApi.GetPodsByDaemonSet)
	g.GET(":agent/deployments/:deploymentId", agentApi.GetPodsByDeployment)
	g.GET(":agent/ingresses/:ingressId", agentApi.GetPodsByIngress)
	g.GET(":agent/namespaces/:namespacesId", agentApi.GetPodsByNamespace)
	g.GET(":agent/networkPolicies/:networkPolicyId", agentApi.GetPodsByConfigMap)
	g.GET(":agent/nodes/:nodeId", agentApi.GetPodsByNode)
	g.GET(":agent/persistentVolumes/:persistentVolumeId", agentApi.GetPodsByConfigMap)
	g.GET(":agent/persistentVolumeClaims/:persistentVolumeClaimId", agentApi.GetPodsByPVC)
	g.GET(":agent/replicaSets/:replicaSetId", agentApi.GetPodsByReplicaSet)
	g.GET(":agent/roles/:roleId", agentApi.GetPodsByRole)
	g.GET(":agent/roleBindings/:roleBindingId", agentApi.GetPodsByRoleBinding)
	g.GET(":agent/secrets/:secretId", agentApi.GetPodsBySecret)
	g.GET(":agent/services/:serviceId", agentApi.GetPodsByService)
	g.GET(":agent/serviceAccounts/:serviceAccountId", agentApi.GetPodsByServiceAccount)
	g.GET(":agent/statefulSets/:statefulSetId", agentApi.GetPodsByStatefulSet)
}
