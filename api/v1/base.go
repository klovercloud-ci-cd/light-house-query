...
func AgentRouter(g *echo.Group) {
	...
	g.GET(":agent/certificates/:certificateId/pods", agentApi.GetPodsByCertificate)
	g.GET(":agent/clusterRoles/:clusterRoleId/pods", agentApi.GetPodsByClusterRole)
	g.GET(":agent/clusterRoleBindings/:clusterRoleBindingId/pods", agentApi.GetPodsByClusterRoleBinding)
	g.GET(":agent/configMaps/:configMapId/pods", agentApi.GetPodsByConfigMap)
	...
	g.GET(":agent/ingresses/:ingressId/pods", agentApi.GetPodsByIngress)
	g.GET(":agent/namespaces/:namespacesId/pods", agentApi.GetPodsByNamespace)
	g.GET(":agent/networkPolicies/:networkPolicyId/pods", agentApi.GetPodsByConfigMap)
	g.GET(":agent/nodes/:nodeId/pods", agentApi.GetPodsByNode)
	g.GET(":agent/persistentVolumes/:persistentVolumeId/pods", agentApi.GetPodsByConfigMap)
	g.GET(":agent/persistentVolumeClaims/:persistentVolumeClaimId/pods", agentApi.GetPodsByPVC)
	g.GET(":agent/replicaSets/:replicaSetId/pods", agentApi.GetPodsByReplicaSet)
	g.GET(":agent/roles/:roleId/pods", agentApi.GetPodsByRole)
	g.GET(":agent/roleBindings/:roleBindingId/pods", agentApi.GetPodsByRoleBinding)
	g.GET(":agent/secrets/:secretId/pods", agentApi.GetPodsBySecret)
	g.GET(":agent/services/:serviceId/pods", agentApi.GetPodsByService)
	g.GET(":agent/serviceAccounts/:serviceAccountId/pods", agentApi.GetPodsByServiceAccount)
