...
func (d daemonSetRepository) Get(agent string, option v1.ResourceQueryOption) ([]v1.DaemonSet, int64) {
...
func (d daemonSetRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.DaemonSet, int64) {
	var results []v1.DaemonSet
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
...
func (d daemonSetRepository) GetByProcessId(agent, processId string, option v1.ResourceQueryOption) ([]v1.DaemonSet, int64) {
	var results []v1.DaemonSet
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
