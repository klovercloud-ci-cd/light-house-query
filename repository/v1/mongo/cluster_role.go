...
func (c clusterRoleRepository) Get(agent string, option v1.ResourceQueryOption) ([]v1.ClusterRole, int64) {
...
func (c clusterRoleRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.ClusterRole, int64) {
	var results []v1.ClusterRole
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
...
func (c clusterRoleRepository) GetByProcessId(agent, processId string, option v1.ResourceQueryOption) ([]v1.ClusterRole, int64) {
	var results []v1.ClusterRole
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
