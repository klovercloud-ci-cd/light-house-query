...
func (s serviceAccountRepository) Get(agent string, option v1.ResourceQueryOption) ([]v1.ServiceAccount, int64) {
...
func (s serviceAccountRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.ServiceAccount, int64) {
	var results []v1.ServiceAccount
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
