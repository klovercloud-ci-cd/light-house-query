...
func (i ingressRepository) Get(agent string, option v1.ResourceQueryOption) ([]v1.Ingress, int64) {
...
func (i ingressRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.Ingress, int64) {
	var results []v1.Ingress
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
