...
func (s secretRepository) Get(agent string, option v1.ResourceQueryOption) ([]v1.Secret, int64) {
...
func (s secretRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.Secret, int64) {
	var results []v1.Secret
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
