...
func (d deploymentRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.Deployment, int64) {
	var results []v1.Deployment
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
...
func (d deploymentRepository) GetByProcessId(agent, processId string, option v1.ResourceQueryOption) ([]v1.Deployment, int64) {
	var results []v1.Deployment
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
