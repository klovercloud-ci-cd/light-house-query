...
func (n namespaceRepository) Get(agent string, option v1.ResourceQueryOption) ([]v1.Namespace, int64) {
...
func (n namespaceRepository) GetByOwnerReference(agent, ownerReference string, option v1.ResourceQueryOption) ([]v1.Namespace, int64) {
	var results []v1.Namespace
	query := bson.M{
		"$and": []bson.M{
			{"agent_name": agent},
